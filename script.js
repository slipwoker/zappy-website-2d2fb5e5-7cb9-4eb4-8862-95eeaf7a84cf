document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (!isEmpty) {
        if ((field.type === 'email' || field.dataset.validate === 'email') && !VALIDATORS.email(value)) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "אתר גיימינג במחיירים זולים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '2d2fb5e5-7cb9-4eb4-8862-95eeaf7a84cf',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '2d2fb5e5-7cb9-4eb4-8862-95eeaf7a84cf';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '2d2fb5e5-7cb9-4eb4-8862-95eeaf7a84cf';
